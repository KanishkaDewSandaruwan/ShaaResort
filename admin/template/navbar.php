...
<nav id="sidebar" class="sidebar js-sidebar">
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav mt-2">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="rooms.php">
                    <i class="align-middle" data-feather="file"></i> <span class="align-middle">Rooms</span>
                </a>
            </li>
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="booking.php">
                    <i class="align-middle" data-feather="book"></i> <span class="align-middle">Bookings</span>
                </a>
            </li>
            <li class="sidebar-item">
